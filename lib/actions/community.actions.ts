...
export async function addMemberToCommunity(
  ...
  try {
    ...
    // Handle any errors
    console.error(
      "Error adding member to community:",
      error
    );
    throw error;
  }
...
export async function removeUserFromCommunity(
  ...
  try {
    ...
    // Handle any errors
    console.error(
      "Error removing user from community:",
      error
    );
    throw error;
  }
...
export async function updateCommunityInfo(
  ...
  try {
    ...
    // Handle any errors
    console.error(
      "Error updating community information:",
      error
    );
    throw error;
  }
...
export async function deleteCommunity(communityId: string) {
  try {
    ...
    // Delete all Bubbles associated with the community
    await Bubble.deleteMany({ community: communityId });
    ...
    const updateUserPromises = communityUsers.map(
      (user) => {
